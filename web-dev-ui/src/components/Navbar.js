...
export default function Navbar({ setShowJoinModal }) {
        ...
        <nav className='flex p-3 text-2xl'>
            ...
            <div className='hidden lg:w-1/3 lg:block'>
                <div className='flex justify-between'>
                    ...
                    <span onClick={() => setShowJoinModal(true)} className='cursor-pointer '>
                        <div className='px-2 py-1 rounded-md hover-bg-gray' >
                            join
                        </div>
                    </span>
                </div>
            ...
            <div className='flex justify-end lg:w-1/3 '>
                <a href='https://www.instagram.com/phswebdev/' className='w-8 h-8 mr-2' ><FontAwesomeIcon className='w-full h-full' icon={faInstagram} /></a>
